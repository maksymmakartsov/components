...
import { Attribute, ChangeDetectionStrategy, ChangeDetectorRef, Component, ElementRef, EventEmitter, forwardRef, Inject, Input, NgZone, Optional, Output, ViewChild, ViewEncapsulation, NgModule } from '@angular/core';
...
class MatSlider {
    ...
    constructor(_elementRef, _changeDetectorRef, _ngZone, _platform, _dir, tabIndex, _animationMode) {
        ...
        this._sliderAdapter = {
             ...
             * @return {?}
             */
            (handler) => window.removeEventListener('resize', handler, listenerOptions)),
            notifyInput: (/**
             * @return {?}
             */
            () => {
...
export { MAT_SLIDER_VALUE_ACCESSOR, MatSliderChange, MatSlider, MatSliderModule };

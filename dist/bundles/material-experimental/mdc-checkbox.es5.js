...
import { Attribute, ChangeDetectionStrategy, ChangeDetectorRef, Component, EventEmitter, forwardRef, Inject, Input, Optional, Output, ViewChild, ViewEncapsulation, NgModule } from '@angular/core';
import { NG_VALUE_ACCESSOR } from '@angular/forms';
import { MAT_CHECKBOX_CLICK_ACTION, _MatCheckboxRequiredValidatorModule } from '@angular/material/checkbox';
export { MAT_CHECKBOX_CLICK_ACTION, MAT_CHECKBOX_REQUIRED_VALIDATOR, MatCheckboxRequiredValidator, _MatCheckboxRequiredValidatorModule, TransitionCheckState } from '@angular/material/checkbox';
...
export { MAT_CHECKBOX_CONTROL_VALUE_ACCESSOR, MatCheckboxChange, MatCheckbox, MatCheckboxModule };
//# sourceMappingURL=mdc-checkbox.es5.js.map

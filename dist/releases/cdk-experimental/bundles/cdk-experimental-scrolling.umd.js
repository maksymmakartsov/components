...
(function (global, factory) {
	...
	(factory((global.ng = global.ng || {}, global.ng.cdkExperimental = global.ng.cdkExperimental || {}, global.ng.cdkExperimental.scrolling = {}),global.ng.cdk.coercion,global.ng.cdk.scrolling,global.ng.core,global.rxjs));
 ...
 * item size.
 */
ItemSizeAverager = /** @class */ (function () {
     ...
     * @return {?}
     */
    ItemSizeAverager.prototype.getAverageItemSize = /**
     * Returns the average item size.
     * @return {?}
     */
    function () {
     ...
     * @return {?}
     */
    ItemSizeAverager.prototype.addSample = /**
     * Adds a measurement sample for the estimator to consider.
     * @param {?} range The measured range.
     * @param {?} size The measured size of the given range in pixels.
     * @return {?}
     ...
     * @return {?}
     */
    ItemSizeAverager.prototype.reset = /**
     * Resets the averager.
     * @return {?}
     */
    function () {
 ...
 * Virtual scrolling strategy for lists with items of unknown or dynamic size.
 */
AutoSizeVirtualScrollStrategy = /** @class */ (function () {
    /**
    ...
    function AutoSizeVirtualScrollStrategy(minBufferPx, maxBufferPx, averager) {
         ...
         */
        this.scrolledIndexChange = new rxjs.Observable((/**
         * @return {?}
         */
        function () {
     ...
     * @return {?}
     */
    AutoSizeVirtualScrollStrategy.prototype.attach = /**
     * Attaches this scroll strategy to a viewport.
     * @param {?} viewport The viewport to attach this strategy to.
     * @return {?}
     */
     ...
     * @return {?}
     */
    AutoSizeVirtualScrollStrategy.prototype.detach = /**
     * Detaches this scroll strategy from the currently attached viewport.
     * @return {?}
     */
    function () {
     ...
     * @return {?}
     */
    AutoSizeVirtualScrollStrategy.prototype.onContentScrolled = /**
     * \@docs-private Implemented as part of VirtualScrollStrategy.
     * @return {?}
     */
    function () {
     ...
     * @return {?}
     */
    AutoSizeVirtualScrollStrategy.prototype.onDataLengthChanged = /**
     * \@docs-private Implemented as part of VirtualScrollStrategy.
     * @return {?}
     */
    function () {
     ...
     * @return {?}
     */
    AutoSizeVirtualScrollStrategy.prototype.onContentRendered = /**
     * \@docs-private Implemented as part of VirtualScrollStrategy.
     * @return {?}
     */
    function () {
     ...
     * @return {?}
     */
    AutoSizeVirtualScrollStrategy.prototype.onRenderedOffsetChanged = /**
     * \@docs-private Implemented as part of VirtualScrollStrategy.
     * @return {?}
     */
    function () {
     ...
     * @return {?}
     */
    AutoSizeVirtualScrollStrategy.prototype.scrollToIndex = /**
     * Scroll to the offset for the given index.
     * @return {?}
     */
    function () {
     ...
     * @return {?}
     */
    AutoSizeVirtualScrollStrategy.prototype.updateBufferSize = /**
     * Update the buffer parameters.
     * @param {?} minBufferPx The minimum amount of buffer rendered beyond the viewport (in pixels).
     * @param {?} maxBufferPx The number of buffer items to render beyond the edge of the viewport (in
     *     pixels).
     * @return {?}
     */
    function (minBufferPx, maxBufferPx) {
     ...
     * @return {?}
     */
    AutoSizeVirtualScrollStrategy.prototype._updateRenderedContentAfterScroll = /**
     * Update the rendered content after the user scrolls.
     * @private
     * @return {?}
     */
    function () {
        /** @type {?} */
        var viewport = (/** @type {?} */ (this._viewport));
     ...
     * @return {?}
     */
    AutoSizeVirtualScrollStrategy.prototype._checkRenderedContentSize = /**
     * Checks the size of the currently rendered content and uses it to update the estimated item size
     * and estimated total content size.
     * @private
     * @return {?}
     ...
     * @return {?}
     */
    AutoSizeVirtualScrollStrategy.prototype._checkRenderedContentOffset = /**
     * Checks the currently rendered content offset and saves the value for later use.
     * @private
     * @return {?}
     */
     ...
     * @return {?}
     */
    AutoSizeVirtualScrollStrategy.prototype._renderContentForCurrentOffset = /**
     * Recalculates the rendered content based on our estimate of what should be shown at the current
     * scroll offset.
     * @private
     * @return {?}
     ...
     * @return {?} a range estimated to be large enough to fill the viewport when rendered.
     */
    AutoSizeVirtualScrollStrategy.prototype._getVisibleRangeForIndex = 
    // TODO: maybe move to base class, can probably share with fixed size strategy.
    /**
     * Gets the visible range of data for the given start index. If the start index is too close to
     * the end of the list it may be backed up to ensure the estimated size of the range is enough to
     ...
     * @return {?} The expanded range.
     */
    AutoSizeVirtualScrollStrategy.prototype._expandRange = 
    // TODO: maybe move to base class, can probably share with fixed size strategy.
    /**
     * Expand the given range by the given amount in either direction.
     * Note: must not be called if `this._viewport` is null
     ...
     * @return {?}
     */
    AutoSizeVirtualScrollStrategy.prototype._updateTotalContentSize = /**
     * Update the viewport's total content size.
     * @private
     * @param {?} renderedContentSize
     * @return {?}
     */
    function (renderedContentSize) {
        /** @type {?} */
        var viewport = (/** @type {?} */ (this._viewport));
        /** @type {?} */
        var renderedRange = viewport.getRenderedRange();
...
var CdkAutoSizeVirtualScroll = /** @class */ (function () {
     ...
     * @return {?}
     */
    CdkAutoSizeVirtualScroll.prototype.ngOnChanges = /**
     * @return {?}
     */
    function () {
        ...
        { type: core.Directive, args: [{
                    ...
                    providers: [{
                            ...
                            deps: [core.forwardRef((/**
                                 * @return {?}
                                 */
                                function () { return CdkAutoSizeVirtualScroll; }))],
                        }],
                },] },
    ];
